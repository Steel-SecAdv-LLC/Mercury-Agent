...
Example:
    Add health routes to FastAPI app::
        ...
        from omni_anomaly_engine.api.health import health_router
...
async def health_metrics() -> Response:
    ...
    lines = [
        "# HELP omni_ava_up Application up status (1=up, 0=down)",
        "# TYPE omni_ava_up gauge",
        f"omni_ava_up {1 if overall_status != HealthStatus.UNHEALTHY else 0}",
        "",
        "# HELP omni_ava_uptime_seconds Application uptime in seconds",
        "# TYPE omni_ava_uptime_seconds counter",
        f"omni_ava_uptime_seconds {checker.get_uptime():.2f}",
        "",
        "# HELP omni_ava_component_status Component health status (1=up, 0.5=degraded, 0=down)",
        "# TYPE omni_ava_component_status gauge",
    ]
    ...
    lines.append("")
    lines.append("# HELP omni_ava_component_latency_ms Component check latency in milliseconds")
    lines.append("# TYPE omni_ava_component_latency_ms gauge")
