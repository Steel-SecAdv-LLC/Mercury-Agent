...
Real-World Benchmark Suite for OMNI ♱ AVA
...
class RealWorldBenchmarkSuite:
    ...
    Example:
        >>> from omni_anomaly_engine.datasets.benchmarks import RealWorldBenchmarkSuite
    ...
    def print_summary(
        ...
        lines = []
        lines.append("=" * 80)
        lines.append("OMNI ♱ AVA REAL-WORLD BENCHMARK RESULTS")
        lines.append("=" * 80)
        lines.append("")
