...
Resilience and error recovery utilities for OMNI AVA.
...
Example:
    Using circuit breaker::
        ...
        from omni_anomaly_engine.utils.resilience import CircuitBreaker
    ...
    Graceful shutdown::
        ...
        from omni_anomaly_engine.utils.resilience import GracefulShutdown
