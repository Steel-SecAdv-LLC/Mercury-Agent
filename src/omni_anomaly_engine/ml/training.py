...
class Trainer:
    ...
    def load_checkpoint(self, path: str) -> None:
        ...
        Security Note:
            This method uses weights_only=False because optimizer state requires
            full deserialization. Only load checkpoints from trusted sources
            (i.e., files generated by this application's save_checkpoint method).
            Loading untrusted checkpoint files can execute arbitrary code.
            See: https://pytorch.org/docs/stable/generated/torch.load.html
        """
        # Security: weights_only=False required for optimizer state, only load trusted files
