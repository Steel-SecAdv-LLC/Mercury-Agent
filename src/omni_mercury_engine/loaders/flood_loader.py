...
Connects to the USGS National Water Information System (NWIS) Instantaneous
Values web service to retrieve streamflow gauge height and discharge time
series.  Ground truth events cover major US flood disasters where gauge
readings exceeded documented NWS flood stages, plus supplemental FEMA
