...
Each loader connects to real-world APIs and data sources,
fetches historical events with ground truth labels, and
provides data in a format ready for MercuryAnomalyDetector.
