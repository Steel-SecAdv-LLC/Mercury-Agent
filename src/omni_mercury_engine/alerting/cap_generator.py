...
Generates valid CAP 1.2 XML payloads from Mercury anomaly detections.
CAP is the international standard for emergency alerts used by
FEMA IPAWS, WMO, and emergency management agencies worldwide.
