...
class NASAExoplanetLoader(DatasetLoader):
    ...
    def _process_tap_data(self, records: list[Any]) -> tuple[npt.NDArray[Any], np.ndarray]:
...
class SolarDynamicsLoader(DatasetLoader):
    ...
    def _process_swpc_data(self, data: list[dict[str, Any]]) -> tuple[npt.NDArray[Any], np.ndarray]:
