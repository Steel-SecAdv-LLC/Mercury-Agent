    ...
    def train_step(self, x: torch.Tensor, train_discriminator: bool = True) -> dict[str, float]:
        ...
        if self.model.discriminator is not None and self.optimizer_d is not None:
            ...
            if train_discriminator:
                ...
                d_loss.backward()  # type: ignore[no-untyped-call, unused-ignore]
        ...
        g_loss.backward()  # type: ignore[no-untyped-call, unused-ignore]
...
class MAMLOptimizer:
    ...
    def meta_train_step(
        ...
        meta_loss.backward()  # type: ignore[no-untyped-call, unused-ignore]
