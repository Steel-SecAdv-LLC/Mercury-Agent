...
class FinancialCrisisDetector:
    ...
    def predict_financial_crisis(
        ...
        if self.enable_market and "market_data" in financial_data and self.market_detector is not None:
        ...
        if self.enable_banking and "banking_data" in financial_data and self.banking_detector is not None:
        ...
        if self.enable_systemic and "network_data" in financial_data and self.systemic_analyzer is not None:
