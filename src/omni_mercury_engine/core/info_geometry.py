...
class StatisticalManifold:
    ...
    Stores the reference parameters (mean, covariance) together with the
    Fisher metric at that point, and provides geodesic-distance and
    exponential-map utilities.
    """
