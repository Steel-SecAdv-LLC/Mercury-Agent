...
class QuantumAnomalyDetector:
    ...
    def _normalize_data(self, X: npt.NDArray[Any]) -> npt.NDArray[Any]:
    ...
    def _fit_vqe(self, X_train: npt.NDArray[Any], **kwargs: Any) -> VQEAnomalyDetector:
    ...
    def _fit_qaoa(self, X_train: npt.NDArray[Any], **kwargs: Any) -> QAOAAnomalyDetector:
    ...
    def _compute_similarity_matrix(self, X: npt.NDArray[Any]) -> npt.NDArray[Any]:
    ...
    def _detect_quantum_kernel(self, X: npt.NDArray[Any]) -> npt.NDArray[Any]:
    ...
    def _detect_vqe(self, X: npt.NDArray[Any]) -> npt.NDArray[Any]:
        """Detect using VQE."""
        return self._trained_model.score(X)

    def _detect_qaoa(self, X: npt.NDArray[Any]) -> npt.NDArray[Any]:
        """Detect using QAOA."""
        return self._trained_model.score(X)

    def _detect_amplitude_estimation(self, X: npt.NDArray[Any]) -> npt.NDArray[Any]:
        """
