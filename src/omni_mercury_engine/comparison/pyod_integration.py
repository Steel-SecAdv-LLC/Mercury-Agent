...
class PyODComparison:
    ...
    def benchmark_against_pyod(
        ...
        """
        results = {
            "omni_mercury": self._evaluate_detector(omni_engine, test_data, ground_truth),
            "pyod_algorithms": {},
        }
    ...
    def _generate_comparison_summary(self, results: dict[str, Any]) -> dict[str, Any]:
        """Generate summary comparing Mercury-Agent with PyOD algorithms."""
        return {
            "omni_mercury_strengths": [
            ...
            "recommendation": (
                "Use Mercury-Agent for STEM-specific anomaly detection with domain fusion;"
