...
def _range_precision(gt_segs: list[tuple[int, int]], pred_segs: list[tuple[int, int]], alpha: float, cardinality: str, bias: str) -> float:
...
def _range_recall(gt_segs: list[tuple[int, int]], pred_segs: list[tuple[int, int]], alpha: float, cardinality: str, bias: str) -> float:
