...
Provides a StreamingDetector wrapper that accepts data points one at a
time, maintains a rolling window, and produces anomaly scores using
MercuryAnomalyDetector. Supports async ingestion via asyncio + aiohttp
for real-time API data feeds.
