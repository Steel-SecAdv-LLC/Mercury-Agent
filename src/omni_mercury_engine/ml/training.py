...
class Trainer:
    ...
    def load_checkpoint(self, path: str) -> None:
        ...
        Security Note:
            ...
            optimizer state restored here is a standard PyTorch
            tensor dict and round-trips cleanly under the safe mode.
            Legacy checkpoints that fail must be re-saved by the
            operator with the current code path; the unsafe fallback
            was removed.
