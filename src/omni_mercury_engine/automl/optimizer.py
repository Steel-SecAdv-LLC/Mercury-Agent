...
class MercuryAutoML:
    ...
    def _compute_auc(self, y_true: npt.NDArray[Any], y_scores: npt.NDArray[Any]) -> float:
...
class SimpleAnomalyModel:
    ...
    def fit(self, X: npt.NDArray[Any], y: npt.NDArray[Any] | None = None) -> SimpleAnomalyModel:
        """Fit the model."""
...
class SimpleClassifier:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._X_train: npt.NDArray[Any] | None = None
        self._y_train: npt.NDArray[Any] | None = None

    def fit(self, X: npt.NDArray[Any], y: npt.NDArray[Any]) -> SimpleClassifier:
        """Fit the classifier."""
        self._X_train = X
        self._y_train = y
        return self
...
class SimpleRegressor:
    ...
    def fit(self, X: npt.NDArray[Any], y: npt.NDArray[Any]) -> SimpleRegressor:
        """Fit the regressor."""
        self._X_train = X
        self._y_train = y
        return self
