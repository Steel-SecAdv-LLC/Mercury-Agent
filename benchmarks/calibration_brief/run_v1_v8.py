...
def main() -> int:
    ...
    record("V2", abs(b_cal - bound) < 5e-3,
    ...
    record("V3", ratio >= 3.0,
           f"ECE {e_raw:.4f} -> {e_cal:.4f}  ({ratio:.1f}x)  (prior 14.5x)")
    ...
    record("V6", (mism < 1e-9) and (ratio6 >= 3.0),
