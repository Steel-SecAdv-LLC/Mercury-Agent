...
class TestMedicalDatasets:
    ...
    def test_mimic_loader_credential_gate(self, tmpdir) -> None:
    ...
    def test_physionet_loader_ecg(self, tmpdir) -> None:
    ...
    def test_sepsis_dataset(self, tmpdir) -> None:
...
class TestSpaceDatasets:
    ...
    def test_seti_loader_deprecated(self, tmpdir) -> None:
    ...
    def test_exoplanet_loader(self, tmpdir) -> None:
    ...
    def test_solar_dynamics_loader(self, tmpdir) -> None:
...
class TestEnvironmentalDatasets:
    ...
    def test_earthquake_loader(self, tmpdir) -> None:
    ...
    def test_weather_loader(self, tmpdir) -> None:
    ...
    def test_wildfire_loader(self, tmpdir) -> None:
...
class TestSecurityDatasets:
    ...
    def test_nslkdd_loader(self, tmpdir) -> None:
        """Test NSL-KDD loader."""
        config = DatasetConfig(
            name="nsl-kdd",
            data_dir=tmpdir,
    ...
    def test_cicids_loader(self, tmpdir) -> None:
        """Test CICIDS loader."""
        config = DatasetConfig(
            name="cicids",
            data_dir=tmpdir,
    ...
    def test_threat_intel_loader(self, tmpdir) -> None:
...
class TestBenchmarkSuite:
    ...
    def test_benchmark_single_dataset(self, tmpdir) -> None:
    ...
    def test_benchmark_multiple_datasets(self, tmpdir) -> None:
    ...
    def test_baseline_comparison(self, tmpdir) -> None:
    ...
    def test_save_and_load_results(self, tmpdir) -> None:
...
class TestPyTorchIntegration:
    ...
    def test_to_pytorch_dataset(self, tmpdir) -> None:
    ...
    def test_get_dataloader(self, tmpdir) -> None:
