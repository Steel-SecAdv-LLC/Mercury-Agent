...
class TestUser:
    ...
    def test_user_has_permission_direct(self) -> None:
    ...
    def test_user_admin_has_all_permissions(self) -> None:
...
class TestAPIKey:
    ...
    def test_api_key_not_expired_no_expiry(self) -> None:
    ...
    def test_api_key_not_expired_future(self) -> None:
    ...
    def test_api_key_expired_past(self) -> None:
...
class TestAPIKeyStore:
    ...
    def test_create_key_returns_raw_and_object(self) -> None:
    ...
    def test_create_key_default_permissions(self) -> None:
    ...
    def test_create_key_custom_permissions(self) -> None:
    ...
    def test_get_by_key_found(self) -> None:
    ...
    def test_update_last_used_nonexistent(self) -> None:
...
class TestAPIKeyAuth:
    ...
    @pytest.mark.asyncio
    async def test_missing_api_key_auto_error(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_missing_api_key_no_auto_error(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_invalid_api_key_auto_error(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_revoked_api_key_raises(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_expired_api_key_raises(self) -> None:
...
class TestRequireRole:
    ...
    @pytest.mark.asyncio
    async def test_role_granted(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_role_denied(self) -> None:
...
class TestGlobalAccessors:
    ...
    def test_get_api_key_store_returns_same_instance(self) -> None:
