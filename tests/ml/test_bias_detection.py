...
class TestBiasDetectorEvaluate:
    ...
    def test_evaluate_fair_model(self):
    ...
    def test_evaluate_with_specific_metrics(self):
    ...
    def test_evaluate_all_default_metrics(self):
    ...
    def test_overall_fairness_score_computed(self):
    ...
    def test_sensitive_features_recorded(self):
...
class TestBiasDetectorBuiltinMetrics:
    ...
    def test_demographic_parity_builtin(self):
    ...
    def test_equalized_odds_builtin(self):
    ...
    def test_disparate_impact_builtin(self):
...
class TestBiasDetectorHighRiskGroups:
    ...
    def test_identify_high_risk_groups(self):
    ...
    def test_no_high_risk_groups_when_fair(self):
...
class TestBiasDetectorRecommendations:
    ...
    def test_recommendations_for_unfair_model(self):
    ...
    def test_recommendations_for_fair_model(self):
    ...
    def test_demographic_parity_violation_recommendation(self):
...
class TestBiasDetectorQuickCheck:
    ...
    def test_quick_check_fair_model(self):
...
class TestBiasDetectorMetadata:
    ...
    def test_metadata_includes_fairlearn_status(self):
    ...
    def test_metadata_includes_group_count(self):
...
class TestBiasDetectorThresholdBehavior:
    ...
    def test_disparate_impact_80_rule(self):
