...
class TestComputeAuc:
    ...
    def test_perfect_inverse_separation(self):
    ...
    def test_all_same_class_positive(self):
    ...
    def test_all_same_class_negative(self):
    ...
    def test_two_samples_tied_scores(self):
    ...
    def test_auc_accepts_lists(self):
    ...
    def test_known_three_point_auc(self):
...
class _MockLoader:
    ...
    def get_provenance(self, event_id: str, features: np.ndarray) -> dict:
...
class TestRunDomainBenchmark:
    ...
    def test_returns_results_dict(self, mock_detector_cls, tmp_path):
    ...
    @patch("omni_mercury_engine.detectors.statistical.MercuryAnomalyDetector")
    def test_multiple_events(self, mock_detector_cls, tmp_path):
    ...
    @patch("omni_mercury_engine.detectors.statistical.MercuryAnomalyDetector")
    def test_event_result_has_metrics(self, mock_detector_cls, tmp_path):
    ...
    def test_no_events_exits(self, tmp_path):
    ...
    @patch("omni_mercury_engine.detectors.statistical.MercuryAnomalyDetector")
    def test_summary_has_mean_auc(self, mock_detector_cls, tmp_path):
