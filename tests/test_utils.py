...
def test_normalize_standard(sample_data) -> None:
...
def test_normalize_minmax(sample_data) -> None:
...
def test_compress_decompress(sample_data) -> None:
...
def test_gravitational_lensing(sample_data) -> None:
...
def test_detect_singularity(sample_data) -> None:
