...
class TestSimonsCMAPLoader:
    ...
    @pytest.fixture
    def loader(self, config) -> SimonsCMAPLoader:
...
class TestWorldOceanDatabaseLoader:
    ...
    @pytest.fixture
    def loader(self, config) -> WorldOceanDatabaseLoader:
        """Create loader instance."""
...
class TestCopernicusSeaLevelLoader:
    ...
    @pytest.fixture
    def loader(self, config) -> CopernicusSeaLevelLoader:
        """Create loader instance."""
...
class TestOceanographicDataQuality:
    ...
    @pytest.fixture
    def cmap_loader(self, tmp_path) -> SimonsCMAPLoader:
        """Create CMAP loader."""
