...
class TestMultiElementBinarization:
    ...
    def test_mebin_custom_config(self):
    ...
    def test_rotate_to_horizontal_zero_angle(self):
    ...
    def test_rotate_to_horizontal_nonzero_angle(self):
    ...
    def test_binarize_all_above(self):
    ...
    def test_binarize_all_below(self):
    ...
    def test_process_multi_element(self):
...
class TestNovelClassDiscovery:
    ...
    def test_ncd_custom_config(self):
    ...
    def test_mebin_initialization_when_enabled(self):
    ...
    def test_extract_anomaly_features_grayscale(self):
    ...
    def test_discover_novel_classes_basic(self):
    ...
    def test_discover_classes_assignments_shape(self):
    ...
    def test_discover_classes_labels_format(self):
    ...
    def test_discover_classes_method_label(self):
    ...
    def test_classify_new_anomaly_without_discovery_raises_error(self):
    ...
    def test_classify_new_anomaly_basic(self):
    ...
    def test_classify_predicted_class_idx_valid(self):
    ...
    def test_get_class_statistics_distribution(self):
    ...
    def test_get_class_statistics_most_common(self):
    ...
    def test_get_class_statistics_least_common(self):
    ...
    def test_mebin_enabled_flag_in_results(self):
