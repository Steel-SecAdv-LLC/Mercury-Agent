...
class TestDatabaseStubQuery:
    ...
    @pytest.mark.asyncio
    async def test_select_all(self, db: Any) -> None:
    ...
    @pytest.mark.asyncio
    async def test_select_with_where(self, db: Any) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update(self, db: Any) -> None:
        """Test updating rows."""
        await db.execute("CREATE TABLE users (id INTEGER, name TEXT)")
        await db.execute("INSERT INTO users (id, name) VALUES (1, 'Alice')")
    ...
    @pytest.mark.asyncio
    async def test_delete(self, db: Any) -> None:
        """Test deleting rows."""
        await db.execute("CREATE TABLE users (id INTEGER, name TEXT)")
        await db.execute("INSERT INTO users (id, name) VALUES (1, 'Alice')")
...
class TestDatabaseStubTransactions:
    ...
    @pytest.mark.asyncio
    async def test_begin_transaction(self, db: Any) -> None:
        """Test beginning a transaction."""
        await db.begin()
        assert db._in_transaction is True

    @pytest.mark.asyncio
    async def test_commit_transaction(self, db: Any) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rollback_transaction(self, db: Any) -> None:
...
class TestDatabaseStubSchemaOperations:
    ...
    @pytest.mark.asyncio
    async def test_list_tables(self, db: Any) -> None:
        """Test listing tables."""
    ...
    @pytest.mark.asyncio
    async def test_describe_table(self, db: Any) -> None:
    ...
    @pytest.mark.asyncio
    async def test_drop_table(self, db: Any) -> None:
...
class TestDatabaseStubDataTypes:
    ...
    @pytest.mark.asyncio
    async def test_integer_values(self, db: Any) -> None:
        """Test integer values."""
    ...
    @pytest.mark.asyncio
    async def test_float_values(self, db: Any) -> None:
        """Test float values."""
    ...
    @pytest.mark.asyncio
    async def test_text_values(self, db: Any) -> None:
        """Test text values."""
    ...
    @pytest.mark.asyncio
    async def test_null_values(self, db: Any) -> None:
        """Test NULL values."""
...
class TestDatabaseStubAggregations:
    ...
    @pytest.mark.asyncio
    async def test_count(self, db: Any) -> None:
...
class TestDatabaseStubStatistics:
    ...
    @pytest.mark.asyncio
    async def test_get_stats(self, db: Any) -> None:
    ...
    @pytest.mark.asyncio
    async def test_query_count_tracking(self, db: Any) -> None:
...
class TestDatabaseStubErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_query_nonexistent_table(self, db: Any) -> None:
        """Test querying nonexistent table."""
        with pytest.raises(DatabaseError):
            await db.query("SELECT * FROM nonexistent")

    @pytest.mark.asyncio
    async def test_syntax_error(self, db: Any) -> None:
...
class TestDatabaseStubConnectionManagement:
    ...
    @pytest.mark.asyncio
    async def test_connect(self, db: Any) -> None:
        """Test connecting to database."""
        await db.connect()
        assert db._connected is True

    @pytest.mark.asyncio
    async def test_disconnect(self, db: Any) -> None:
    ...
    @pytest.mark.asyncio
    async def test_is_connected(self, db: Any) -> None:
