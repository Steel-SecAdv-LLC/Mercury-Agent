...
from omni_mercury_engine.detectors.energy.emp_detector import (
    E1PulseDetector,
    E3PulseDetector,
    EMPDetector,
    EMPPredictionResult,
...
class TestE1PulseDetector:
    ...
    def test_no_e1_pulse_normal_conditions(self, detector) -> None:
    ...
    def test_e1_pulse_detected(self, detector) -> None:
    ...
    def test_e1_detection_threshold_boundary(self, detector) -> None:
    ...
    def test_field_strength_captured(self, detector) -> None:
...
class TestE3PulseDetector:
    ...
    def test_no_e3_pulse_normal_conditions(self, detector) -> None:
    ...
    def test_e3_pulse_detected(self, detector) -> None:
    ...
    def test_grid_impact_levels(self, detector) -> None:
    ...
    def test_gic_amplitude_calculation(self, detector) -> None:
...
class TestEMPDetector:
    ...
    def test_predict_normal_conditions(self, detector, normal_emp_data) -> None:
    ...
    def test_predict_e1_event(self, detector, e1_emp_data) -> None:
    ...
    def test_predict_e3_event(self, detector, e3_emp_data) -> None:
    ...
    def test_predict_nuclear_emp(self, detector) -> None:
    ...
    def test_affected_infrastructure_identified(self, detector, e1_emp_data) -> None:
    ...
    def test_protective_actions_generated(self, detector, e1_emp_data) -> None:
    ...
    def test_recovery_actions_generated(self, detector, e1_emp_data) -> None:
    ...
    def test_threat_level_assessment(self, detector) -> None:
    ...
    def test_source_localization_field(self, detector, normal_emp_data) -> None:
