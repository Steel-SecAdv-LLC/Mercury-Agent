...
Validates that the new StatisticalAnomalyDetector ensemble (replacing
...
class TestResonanceScore:
    ...
    def test_single_sample_fallback(self, detector: StatisticalAnomalyDetector) -> None:
    ...
    def test_constant_feature(self, detector: StatisticalAnomalyDetector) -> None:
...
class TestKinematicScore:
    ...
    def test_two_samples(self, detector: StatisticalAnomalyDetector) -> None:
    ...
    def test_three_samples(self, detector: StatisticalAnomalyDetector) -> None:
...
class TestInfoGeometryScore:
    ...
    def test_ood_scored_higher_than_in_dist(self, detector: StatisticalAnomalyDetector) -> None:
    ...
    def test_single_training_sample(self, detector: StatisticalAnomalyDetector) -> None:
