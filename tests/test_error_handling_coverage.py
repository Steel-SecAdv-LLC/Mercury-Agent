...
class _MockClassifier:
    """Minimal fit/predict classifier for testing GWO."""
...
class TestGWOOptimizerErrorHandling:
    ...
    def test_cross_val_failure_logs_and_returns_default(self, caplog):
        ...
        If cross_val_score encounters an error, the ImportError is caught inside
        the objective function's try/except, logged, and returns default fitness.
        ...
        # Use mock classifier — cross_val_score will use the mock's
        # fit/score methods.
        clf = _MockClassifier()
...
class TestCrossValidationErrorHandling:
    ...
    def test_gwo_with_insufficient_samples(self, caplog):
        ...
        trigger failures. GWO must return a valid boolean mask regardless.
        """
        from omni_mercury_engine.ml.gwo_optimizer import GreyWolfOptimizer
