...
class TestPyTorchDependentFeatures:
    ...
    def test_medical_specialties(self):
        ...
        from omni_anomaly_engine.medical.abms_disciplines import ABMSBoard

        specialties = list(ABMSBoard)
    ...
    def test_schumann_detector(self):
        ...
        # schumann_frequencies[0] is the fundamental frequency (7.83 Hz)
        assert abs(detector.schumann_frequencies[0] - 7.83) < 0.1
