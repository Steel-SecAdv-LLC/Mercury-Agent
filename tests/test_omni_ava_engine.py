...
class TestOmniAvaEngine:
    """Test suite for OmniAvaEngine."""

    def test_initialization(self):
        """Test engine initialization with GA-optimized defaults."""
        engine = OmniAvaEngine(state_dim=50)
    ...
    def test_custom_config(self):
        ...
        engine = OmniAvaEngine(config=config, state_dim=30)
    ...
    def test_complexity_performance(self):
        ...
        for size in sizes:
            engine = OmniAvaEngine(state_dim=size)
    ...
    def test_double_helix_architecture(self):
        ...
        engine_linear = OmniAvaEngine(config=config_linear, state_dim=20)
...
class TestOmniAvaIntegration:
    """Integration tests for OmniAvaEngine."""

    def test_threat_detection_simulation(self):
        """Test threat detection in simulated scenario."""
        engine = OmniAvaEngine(state_dim=30)
    ...
    def test_convergence_consistency(self):
        ...
        config_linear = {"use_double_helix": False}
        engine = OmniAvaEngine(config=config_linear, state_dim=20)
